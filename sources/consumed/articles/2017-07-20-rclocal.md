...
register: "consumed"
source: "wayback"
source_id: "fb-1500546189"
url: "http://web.archive.org/web/20210526121859/https://www.raspberrypi.org/documentation/linux/usage/rc-local.md"
provenance: "extracted"
enrichment: "wayback"
lang: "en"
tags: [raspberry-pi, linux, system-administration]
status: "reference"
ingested: "2026-05-30"
created: "2017-07-20"
---
...
NOTE: on Jessie, Stretch and Buster (which use systemd), rc.local
has drawbacks: not all programs will run reliably, because not all services may be available when rc.local
runs.
...
Also, be sure to reference absolute filenames rather than relative to your home folder; for example, /home/pi/myscript.py
rather than myscript.py
.
One more point to note is that all commands will be executed by the root user. This can lead to unexpected behaviour: for example, if a folder is created by a mkdir
command in the script, the folder would have root ownership and would not be accessible by anyone other than the root user.
